...
class OwnerServiceJPATest {
    ...
    @BeforeEach
    void setUp() {
        returneOwner = Owner.builder().id(1L).lastName(LAST_NAME).build();
    }

    @Test
    void findByLastName() {
        when(ownerRepository.findByLastName(any())).thenReturn(returneOwner);
    ...
    @Test
    void findById() {
        when(ownerRepository.findById(anyLong())).thenReturn(Optional.of(returneOwner));
    ...
    void save() {
        ...
        when(ownerRepository.save(any())).thenReturn(returneOwner);
    ...
    @Test
    void delete() {
        ownerService.delete(returneOwner);
